const { registerUser, loginUser, loginAdmin, forgotPassword, verifyOtp, resetPassword } = require("../../controllers/admin/auth/authController")
...
router.route("/admin/login").post(catchAsync(loginAdmin))
